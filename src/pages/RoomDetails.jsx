  ...
  return  room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            ...
            <p className='text-sm font-inter py-1.5 px-3 text-white bg-orange-500 
          ...
          {/* Room Highlights */}
           ...
           <div className='flex flex-col md:flex-row md:justify-between mt-10'>
             <div className='flex flex-col'>
                 <h1 className='text-3xl  md:text-4xl font-playfair'
                 >Expreience Luxury Like Never Before </h1>
             ...
             {/* CheckIn CheckOut Fome */}
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between
              bg-white shadow-[0px_0px_2px_rgba(0,0,0,0.15)] p-6 rounded-xl  max-auto mt-16 max-w-6xl'>
               ...
               gap-4 md:gap-10 text-gray-500'>
                   ...
                   <div className='flex flex-col'>
                       ...
                       w-full rounded border border-gray-500 px-3 py-2 mt-1.5 outline-none required' />
                   </div>

                    <div className='w-px h-15 bg-gray-300/70 max:md-medium'></div>
               ...
               <button type='sumbit' className='bg-primary hover:bg-primary-dull active:scale-95 
            ...
            {/* Common Specifications */}
                ...
                <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                 <p>
                  Guests Will be allocated on the ground floor according to avilability.
                  You get a comfortable Two bedroom apartment has a ture city feeling. The 
                  ...
                  ground floor according to avilability. You get the comfortable two bedroom apartment 
