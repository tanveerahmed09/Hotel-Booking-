...
const Dashboard = () => {
  ...
  const [deshboardData, setDeshboardData] = useState(dashboardDummyData)

  return (
    <div>
      <Title align='left' font='outfit' title='Dashdoard' subTitle='Monitor your
       room listings, track bookings and analyze revenue-all in one place. Stay
       updated with real-time insights to ensure  smooth oprations.  '/>

        <div className='flex gap-4 my-8'>
          {/* -----Total bookings----- */}
           <div className='bg-primary/3 border border-primary/10  rounded flex
           p-4 pr-8'>
              <img src={assets.totalBookingIcon} alt=""  className='max-sm:hidden
              h-10'/>
               <div className='flex flex-col sm:ml-4 font-medium'>
                <p className='text-blue-400 text-lg'>Total Bookings</p>
                <p className='text-neutral-400 text-base' >{dashboardDummyData.
                totalBookings}</p>
               </div>
           </div>
           {/*-----Total Revenue-----  */}
           ...
           p-4 pr-8'>
              ...
              h-10'/>
               <div className='flex flex-col sm:ml-4 font-medium'>
                <p className='text-blue-400 text-lg'>Total Revenue</p>
                <p className='text-neutral-400 text-base' >${dashboardDummyData.
                totalRevenue}</p>
               </div>
           </div>
