...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pd-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        <Title title ='My Bookings' subTitle='Easily manage your post, cuuurent, and
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            border-gray-300 font-medium text-base py-3'>
                ...
                <div className='w-1/3'>Pyment</div>
            </div>

           {bookings.map((booking)=>(
             <div key={booking._id} className='grid grid-col-1 md:grid-cols-[3fr_2fr_1fr]
             w-full border-b border-gray-300 py-6 first:boeder-t '>
                {/*----- Hotel Details ----  */}
                ...
                {/*----- >Date & Timings ----  */}
                <div className='flex flex-row md:items-center md:gap-2 mt-3 gap-8'>
                    <div>
                       <p>Check-In:</p>
