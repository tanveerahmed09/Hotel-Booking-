  ...
  return (
    <div className="pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex flex-col lg:flex-row gap-10 mt-10">
        ...
        {/* Filters */}
        <div className="bg-white w-full lg:w-80 border border-gray-300 text-gray-600 order-1 lg:order-2 h-fit">
          ...
          {/* Filter Body */}
          <div
            className={`${openFilters ? 'max-h-[1000px]' : 'max-h-0 lg:max-h-[1000px]'}
